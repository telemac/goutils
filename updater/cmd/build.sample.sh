...
GOOS=windows GOARCH=amd64 go build -trimpath -o ./bin/windows/amd64/$BINARY
md5 ./bin/linux/amd64/selfupdate > ./bin/linux/amd64/$BINARY.md5
...
rsync -avP ./bin/ update.mydomain.com:~/data/update.mydomain.com/www/
